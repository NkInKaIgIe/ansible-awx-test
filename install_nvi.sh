...
install_base_centos()
{
    if [[ "${OSVERSION}" == "7" ]]; then
        ...
        sh ./NVIDIA-Linux-x86_64-515.43.04.run --ui=none --no-questions
        ...
        sh ./NVIDIA-Linux-x86_64-470.199.02.run --ui=none --no-questions

        # Install Nvidia Toolkit
        # https://developer.nvidia.com/cuda-downloads
        wget https://developer.download.nvidia.com/compute/cuda/11.4.0/local_installers/cuda_11.4.0_470.42.01_linux.run
        sudo sh cuda_11.4.0_470.42.01_linux.run --silent
